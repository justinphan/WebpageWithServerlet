 ...
 * @author Chris
 */
@WebServlet(urlPatterns = {"/ShowSessionAndContextVotes"})
public class ShowSessionAndContextVotes extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("I have voted " + sessionCount + " times"+"</br>");
            ...
            out.println("All users since server startup have voted " + contextCount + " times"+"</br>");
        }  
    }
